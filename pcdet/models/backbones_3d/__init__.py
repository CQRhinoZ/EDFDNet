...
from .escb_dfd_voxelnext import VoxelResBackBone8xEDFDNet
from .spconv_backbone_voxelnext_test import VoxelResBackBone8xVoxelNeXtTest
__all__ = {
    ...
    "VoxelResBackBone8xEDFDNet": VoxelResBackBone8xEDFDNet,
    "VoxelResBackBone8xVoxelNeXtTest": VoxelResBackBone8xVoxelNeXtTest,
}

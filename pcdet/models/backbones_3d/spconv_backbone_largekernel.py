...
class SpatialGroupConv(spconv.SparseModule):
    ...
    def _convert_weight(self, weight):
        # weight [out, 7, 7, 7, in]
        # tmp = self.block.weight.permute(0, 4, 1, 2, 3)
...
class VoxelResBackBone8xLargeKernel3D(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        self.conv2 = spconv.SparseSequential(
            ...
            block(16, 32, spconv_kernel_sizes[0], norm_fn=norm_fn, stride=2, padding=int(spconv_kernel_sizes[0] // 2),
        ...
        self.conv3 = spconv.SparseSequential(
            ...
            block(32, 64, spconv_kernel_sizes[1], norm_fn=norm_fn, stride=2, padding=int(spconv_kernel_sizes[1] // 2),

...
from .vfe_utils import PFNLayerV9, PFNLayerV10, PFNLayerV11, \
    PFNLayerV12, PFNLayerV13, PFNLayerV14, PFNLayerV15, PFNLayerV16, PFNLayerV17, PFNLayerV18, PFNLayerV19
...
class DynamicPillarVFE(VFETemplate):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        # 增强均值点的特征
        # features_mean = torch_scatter.scatter_mean(features, unq_inv, dim=0)
        # for pfn in self.pfn_layers:
        #     features, features_mean = pfn(features, features_mean, unq_inv)
...
class DynamicPillarVFESimple2D(VFETemplate):
    def __init__(self, model_cfg, num_point_features, voxel_size, grid_size, point_cloud_range, **kwargs):
        ...
        for i in range(len(num_filters) - 1):
            ...
            out_filters = num_filters[i + 1]
            pfn_layers.append(
                # PFNLayerV19(in_filters, out_filters, last_layer=(i >= len(num_filters) - 2), first_layer=(i == 0))
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        # batch_dict["points_xyz"] = points[:, 1:]
        return batch_dict

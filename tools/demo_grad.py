...
def main():
    ...
    for idx, data_dict in enumerate(demo_dataset):
        ...
        logger.info('_______forward_________')
        pred_dicts, _ = model.forward(data_dict)
        logger.info('_______forward end_________')
        colors = get_grad(fmap, data_dict)
        pred_boxes = pred_dicts[0]['pred_boxes'].detach()
        pred_scores = pred_dicts[0]['pred_scores'].detach()
        pred_labels = pred_dicts[0]['pred_labels'].detach()
